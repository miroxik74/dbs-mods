...
<div class="col">
    ...
    mod: async function (DBS, message, action, args, command, index) {
        ...
        switch (action.main) {
            case "create":
                const channel = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "delete":
                const channel1 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                const thread1 = channel1.threads.cache.find(t => t.id === DBS.BetterMods.parseAction(action.threadid, message));
                await thread1.delete();
                DBS.callNextAction(command, message, args, index + 1);
                break
            case "archive":
                const channel2 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "unarchive":
                const channel3 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "lock":
                const channel4 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "unlock":
                const channel5 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "join":
                const channel6 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "leave":
                const channel7 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                const thread7 = channel7.threads.cache.find(t => t.id === DBS.BetterMods.parseAction(action.threadid, message));
                await thread7.leave();
                DBS.callNextAction(command, message, args, index + 1);
                break
            case "add":
                const channel8 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
                ...
                break
            case "remove":
                const channel9 = client.channels.cache.get(DBS.BetterMods.parseAction(action.wheretothread, message))
