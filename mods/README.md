...
5. Paste the `js` files to the the `mods` folder inside` BotFiles` (/BotFiles/mods).
6. Now open BSD (restart the app or just switch to the Home tab and again to the Commands to load them), and you will be able to add responses of the type of mod(s) you added, just like any other response in DBS. 
7. Done!
